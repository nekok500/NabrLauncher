...
// Constants
const clientId = 'c554e66c-81a3-4572-929e-b5b6e7b66413'
        ...
        requestPromise(authXSTSUri, options).then(response => {
            if (response.body.XErr) {
                switch (response.body.XErr) {
                    ...
                    case 2148916238: 
                        reject({
                            message: 'Since you are not yet 18 years old, an adult must add you to a family in order for you to use Nabrlauncher!'
                        })
                        return
